...
<%@ page import="com.vuthong.ecommerce.vo.ProductVO"%>
<div class="x_title">
...
<div class="x_content">
	...
	<form:form id="demo-form" modelAttribute="productVO"
		...
		<form:input type="text" path="productId" placeholder="Insert name" hidden="hidden"/>
		...
		<form:select id="heard" path="category" class="form-control" required="required" readonly="true">
			<form:option value="" label="Choose" />
			<form:options items="${categoryList}" />
		</form:select>
		<br>
		<label for="price">Price * :</label>
		<form:input type="number" id="price" path="price" class="form-control" name="price"
			required="required" readonly="true"/>
		<br>
